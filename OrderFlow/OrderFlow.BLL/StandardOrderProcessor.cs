...
// AD-7: resolved via keyed DI for OrderType.Standard. Confirms an order: validates stock,
// computes the total (unmodified base total for Standard), persists Order+OrderItems,
...
public class StandardOrderProcessor : IOrderProcessor
{
    ...
    public async Task<Result<OrderDto>> ConfirmAsync(CreateOrderRequest request)
    {
        ...
        // Step 2: compute total — unmodified base total for Standard orders.
